...
public class ExpenseListAdapter extends ArrayAdapter<IncomeExpenseJournal> {

    Context context;
    ArrayList<IncomeExpenseJournal>incomeExpenseJournalArrayList;


    public ExpenseListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<IncomeExpenseJournal> incomeExpenseJournalArrayList) {
        super(context, R.layout.expenselistview, incomeExpenseJournalArrayList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.expenselistview, parent, false);
                ...
                final AlertDialog.Builder builderdialog = builder.setItems(events, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(which==0 || which==1){
                            ...
                            intent.putExtra("fragment","fragmentExpenseTrans");
